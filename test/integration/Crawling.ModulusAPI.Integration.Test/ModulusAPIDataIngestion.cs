...
{
    public class DataIngestion : IClassFixture<ModulusAPITestFixture>
    {
        private readonly ModulusAPITestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(ModulusAPITestFixture fixture, ITestOutputHelper output)
        {
