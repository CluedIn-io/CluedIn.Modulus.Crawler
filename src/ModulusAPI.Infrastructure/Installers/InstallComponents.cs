...
namespace CluedIn.Crawling.ModulusAPI.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IModulusAPIClientFactory>().AsFactory())
                .Register(Component.For<ModulusAPIClient>().LifestyleTransient());
