...
{
    public class ModulusAPI_Command_MeshProcessor : BaseMeshProcessor
    {
        public ModulusAPI_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          ModulusAPIConstants.ProviderId;
